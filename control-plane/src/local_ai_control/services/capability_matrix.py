...
CAPABILITIES = (
    ...
    Capability("图片理解", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("图片生成编辑", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("音频转写", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("音频理解", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("视频分析", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("Web Search", CapabilityStatus.NOT_STARTED, "approved tool missing"),
    Capability("Deep Research", CapabilityStatus.NOT_STARTED, "workflow missing"),
    Capability("Retrieval/RAG", CapabilityStatus.NOT_STARTED, "embedding missing"),
    ...
    Capability("多模型路由", CapabilityStatus.FOUNDATION, "test_quality_governance"),
    Capability("Embeddings", CapabilityStatus.NOT_STARTED, "provider missing"),
    Capability("长期存储", CapabilityStatus.PARTIAL, "SQLite"),
    Capability("Browser/Computer", CapabilityStatus.NOT_STARTED, "scope missing"),
