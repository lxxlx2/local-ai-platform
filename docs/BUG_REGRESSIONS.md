...
| BUG-ORCH-001 | Internal workflow stopped at an intermediate status | Orchestration | Intermediate status was treated as a terminal response | `test_intermediate_state_can_finish_task` policy regression | Fixed |
